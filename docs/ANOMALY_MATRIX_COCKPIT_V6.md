...
- Validation automatisée : build Vite ✅, E2E Playwright mock ✅ (27/27), suite backend pytest ✅ (31 passed), test d'intégration Anomalie G ✅ (PostgreSQL isolé, incluant le test de parité et la déduplication surface), recette fonctionnelle backend réel ✅ (17/17), navigateur API réelle ✅ (5 scénarios).
