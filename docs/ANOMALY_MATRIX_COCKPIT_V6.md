...
- Limites documentées : la suite mockée standard (27/27) n'a pas été rejouée après ces correctifs UI ; « Risque global »/« Confiance » passent en « Non évalué » sur la grille quand aucune ligne n'est évaluable, mais d'autres cartes (panneaux annexes) ne sont pas toutes couvertes par cet état.
