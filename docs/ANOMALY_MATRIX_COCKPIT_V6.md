...
- **Validations défauts visuels** : build Vite ✅ ; spec navigateur API réelle (`real-api-recipe.spec.js`) ✅ 1 passed — connexion, A (nom « Projet A synthetique » affiché, aucune occurrence « Mpemba », CAPEX Direct 3 000 FCFA), filtre niveau RDC (1 000 FCFA), B (500 FCFA), C vide (message « Aucune donnée pour ce projet » + carte V6 CAPEX Direct 0 FCFA), D/S1 (« Indisponible pour ce perimetre »).
