...
- Validation automatisée : build Vite ✅ (compilation sans erreur), tests backend pytest `test_project_isolation.py` ✅ (8 verts), test d'intégration Anomalie G ✅ (PostgreSQL isolé). Reste à compléter : tests E2E Playwright (scénarios A/C/D/E/F/G).
