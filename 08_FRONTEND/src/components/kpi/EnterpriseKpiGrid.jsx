...
export default function EnterpriseKpiGrid({ kpis = {}, loading = false }) {
  ...
  const items = [
    ...
    { label: "Lignes DQE", value: Number(kpis.nb_lignes || 0).toLocaleString("fr-FR"), helper: "Postes budgetaires", tone: "blue", icon: PackageCheck, delta: kpis.nb_lignes ? 100 : 0, points: [12, 24, 38, 52, 66, 82, 100] },
    { label: "Risque global", value: kpis.risque_global || "Moyen", helper: "Aide a la decision", tone: "amber", icon: AlertTriangle, delta: -4.2, positiveIsGood: false, points: [62, 60, 58, 59, 55, 53, 50] },
