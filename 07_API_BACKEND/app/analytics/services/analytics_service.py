...
CHINA_SUPPLIERS = [
    {
        "supplier": "Guangzhou MediBuild Materials",
        "category": "Alucobond",
        "port": "Guangzhou",
        "fob_usd": 18.2,
        "moq": "1 500 m2",
        ...
        "history": "3 operations similaires",
        "reliability": 86,
        "capacity": "45 000 m2/mois",
        "risk": 34,
    },
    {
        "supplier": "Shanghai Bright Electric",
        ...
        "lead_time_days": 45,
        "quality": 91,
        "certifications": ["IEC", "CE", "ISO 14001"],
        "history": "Fournisseur qualifie",
        "reliability": 89,
        "capacity": "12 containers/mois",
        "risk": 31,
    },
    {
        "supplier": "Ningbo HVAC Systems",
        "category": "CVC",
        "port": "Ningbo",
        "fob_usd": 310.0,
        "moq": "80 equipements",
        "lead_time_days": 52,
        "quality": 87,
        "certifications": ["AHRI", "CE"],
        "history": "2 imports controles",
        "reliability": 82,
        "capacity": "600 equipements/mois",
        "risk": 42,
    },
    {
        "supplier": "Shenzhen Sanitary Tech",
        "category": "Sanitaires",
        "port": "Shenzhen",
        "fob_usd": 56.0,
        "moq": "300 kits",
        ...
        "history": "Prix competitif",
        "reliability": 80,
        "capacity": "8 000 kits/mois",
        "risk": 39,
    },
    {
        "supplier": "Foshan Aluminium Systems",
        ...
        "history": "Controle qualite recommande",
        "reliability": 84,
        "capacity": "20 000 ml/mois",
        "risk": 37,
    },
    {
        "supplier": "Suzhou Lift Medical Projects",
        "category": "Ascenseurs",
        "port": "Shanghai",
        "fob_usd": 28500.0,
        "moq": "1 appareil",
        "lead_time_days": 78,
        "quality": 92,
        "certifications": ["EN81", "CE", "ISO 9001"],
        "history": "Lots techniques sensibles",
        "reliability": 83,
        "capacity": "40 appareils/mois",
        "risk": 48,
    },
    {
        "supplier": "Shenzhen Medical Furniture",
        ...
        "history": "Adaptation medicale possible",
        "reliability": 81,
...
class AnalyticsService:
    ...
    def export_procurement_file(self, query: AnalyticsQuery) -> BytesIO:
        ...
        write_table(
            suppliers_sheet,
            ["Fournisseur", "Categorie", "Port", "FOB USD", "MOQ", "Delai", "Qualite", "Score", "Certifications"],
            [[row.get("supplier"), row.get("category"), row.get("port"), row.get("fob_usd"), row.get("moq"), row.get("lead_time_days"), row.get("quality"), row.get("score"), ", ".join(row.get("certifications", []))] for row in suppliers["table"]],
        )
