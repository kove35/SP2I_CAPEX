...
def ensure_powerbi_schema(engine: Engine) -> None:
    ...
    -- `Base.metadata.create_all()` peut avoir cree la version ORM historique
    -- de cette table avant cette migration. `CREATE TABLE IF NOT EXISTS` ne
    -- complete alors pas les colonnes analytiques attendues ci-dessus.
    ALTER TABLE dim_article_bpu
        ...
        ADD COLUMN IF NOT EXISTS is_bim_compatible BOOLEAN NOT NULL DEFAULT FALSE;
